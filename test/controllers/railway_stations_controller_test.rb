...
class RailwayStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create railway_station" do
    assert_difference('RailwayStation.count') do
      post railway_stations_url, params: { railway_station: { string: @railway_station.string, title: @railway_station.title } }
    end
  ...
  test "should update railway_station" do
    patch railway_station_url(@railway_station), params: { railway_station: { string: @railway_station.string, title: @railway_station.title } }
